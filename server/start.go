...
`,
	...
	cmd.Flags().StringSlice(srvflags.JSONRPCWsOrigins, []string{}, "Defines allowed browser WebSocket origins. Empty list rejects non-empty Origin headers; use '*' to allow all browser origins")
