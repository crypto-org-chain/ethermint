...
replace (
	...
	// TODO: might use crypto-org repo as the refrence path
	github.com/cosmos/cosmos-sdk => github.com/jayt106/cosmos-sdk v0.43.0-rc2.0.20220926180816-39ac2ae4fdde
