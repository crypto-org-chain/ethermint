...
| 3 | ante | ante | 12 | critical (promoted: security gate) |
| 4 | x/evm/statedb | x/evm/statedb | 47 | critical (promoted: EVM state correctness) |
| 5 | ethereum/eip712 | ethereum/eip712 | 26 | critical (promoted: signing security) |
| 6 | x/evm (root files only) | x/evm (root-level .go files only, exclude keeper/, types/, statedb/ subdirectories) | 124 | high |
| 7 | server | server | 110 | medium |
| 8 | types | types | 107 | medium |
| 9 | rpc/backend | rpc/backend | 99 | high |
| 10 | rpc/namespaces/ethereum | rpc/namespaces/ethereum | 54 | high |
| 11 | client | client | 98 | low |
| 12 | cmd/ethermintd | cmd/ethermintd | 66 | medium |
