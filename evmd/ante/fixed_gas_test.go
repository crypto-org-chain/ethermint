...
func (suite *AnteTestSuite) TestFixedGasConsumedDecorator() {
	...
	testCases := []struct {
		...
		{
			name: "whitelisted message - MsgDelegate",
			msgs: []sdk.Msg{
			...
			expectedFixedGas:    cosmosante.WhitelistedMessages[sdk.MsgTypeURL(&stakingtypes.MsgDelegate{})],
		...
		{
			name: "whitelisted message - MsgCancelUnbondingDelegation",
			msgs: []sdk.Msg{
			...
			expectedFixedGas:    cosmosante.WhitelistedMessages[sdk.MsgTypeURL(&stakingtypes.MsgCancelUnbondingDelegation{})],
			expectFixedGasMeter: true,
		},
		{
			name: "whitelisted message - MsgEditValidator",
			msgs: []sdk.Msg{
			...
			expectedFixedGas:    cosmosante.WhitelistedMessages[sdk.MsgTypeURL(&stakingtypes.MsgEditValidator{})],
			expectFixedGasMeter: true,
		},
		{
			...
			expectedFixedGas:    cosmosante.WhitelistedMessages[sdk.MsgTypeURL(&stakingtypes.MsgCreateValidator{})],
			expectFixedGasMeter: true,
		},
		{
			name: "multiple whitelisted messages - MsgDelegate + MsgUndelegate",
			msgs: []sdk.Msg{
				stakingtypes.NewMsgDelegate(
					addr.String(),
					valAddr.String(),
			...
			expectedFixedGas:    cosmosante.WhitelistedMessages[sdk.MsgTypeURL(&stakingtypes.MsgDelegate{})] + cosmosante.WhitelistedMessages[sdk.MsgTypeURL(&stakingtypes.MsgUndelegate{})],
			expectFixedGasMeter: true,
		},
		{
			...
			expectedFixedGas:    cosmosante.WhitelistedMessages[sdk.MsgTypeURL(&stakingtypes.MsgDelegate{})], // additional fixed gas consumed should only be for the whitelisted one
			expectFixedGasMeter: true,
		},
		{
			name: "multiple whitelisted messages - all staking types",
			msgs: []sdk.Msg{
				stakingtypes.NewMsgDelegate(
					addr.String(),
					valAddr.String(),
			...
			expectedFixedGas:    cosmosante.WhitelistedMessages[sdk.MsgTypeURL(&stakingtypes.MsgDelegate{})] + cosmosante.WhitelistedMessages[sdk.MsgTypeURL(&stakingtypes.MsgUndelegate{})] + cosmosante.WhitelistedMessages[sdk.MsgTypeURL(&stakingtypes.MsgEditValidator{})],
			expectFixedGasMeter: true,
		},
	}
