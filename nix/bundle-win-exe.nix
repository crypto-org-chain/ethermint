...
runCommand "tarball-${ethermintd.name}"
{
  # manually enumerate the runtime dependencies of ethermintd on mingwW64
  deps = [
  ...
  cp ${ethermintd}/bin/${ethermintd.meta.mainProgram} $out/
''
