...
type Keeper interface {
	...
	AddBalance(ctx sdk.Context, addr sdk.AccAddress, coins sdk.Coins) (uint256.Int, error)
	SubBalance(ctx sdk.Context, addr sdk.AccAddress, coins sdk.Coins) (uint256.Int, error)
	SetBalance(ctx sdk.Context, addr common.Address, amount uint256.Int, denom string) (uint256.Int, error)
