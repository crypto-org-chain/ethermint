...
* (eip7702) [#1110](https://github.com/crypto-org-chain/ethermint/pull/1110) fix(eip7702): convert BaseAccount to EthAccount when code is set and block vesting accounts getting delegated in eip-7702.
