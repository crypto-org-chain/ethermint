...
* (rpc) [#1003](https://github.com/crypto-org-chain/ethermint/pull/1003) feat(rpc): direct app-mempool insert for EVM tx submission when `mempool.type=app` (apps implement `MempoolTxInserter`); falls back to `BroadcastTx`.
