...
* (rpc) [#923](https://github.com/crypto-org-chain/ethermint/pull/923) fix(rpc): include block-gas-exceeded txs in `eth_getBlockReceipts` and fix block-wide `cumulativeGasUsed`. Reindex required for accurate cumulative on multi-eth-tx blocks.
