...
* (evm) [#725](https://github.com/crypto-org-chain/ethermint/pull/743) Optimize staking endblocker execution by caching queue entries from iterators and reducing bech32 conversion.
