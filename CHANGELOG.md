...
- (statedb) [#359](https://github.com/crypto-org-chain/ethermint/pull/359) Add `ExecuteNativeQuery` method to StateDB, to support more efficient read-only native actions.
