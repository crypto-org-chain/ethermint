...
* (rpc) [#923](https://github.com/crypto-org-chain/ethermint/pull/923) fix(rpc): include block-gas-exceeded txs in `eth_getBlockReceipts`, compute block-wide eth `cumulativeGasUsed`, and restore indexer-overwrite guard on `GetTransactionReceipt`.
