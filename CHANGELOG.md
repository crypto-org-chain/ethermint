...
* (rpc) [#1003](https://github.com/crypto-org-chain/ethermint/pull/1003) feat(rpc): submit EVM transactions straight to the app mempool when it is enabled, instead of going through CometBFT's broadcast path.
